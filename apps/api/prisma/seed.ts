...
const templates = [
    ...
    },
    {
        ...
        description:
            'Step-down switching converter: 12V input, 100kHz/50% PWM-driven switch, freewheel power diode + LC filter into a 10Ω load. Run a ~3ms transient to watch it settle to ~5.5V. (Validated on ngspice: 5.50V, ~0.11V ripple.)',
        ...
        circuitJson: {
            ...
            models: [
                ...
                },
                {
                    ...
                    device: 'diode',
                    tier: 'generic',
                    body: '.model DPWR D(IS=1e-10 N=1 RS=0.01 BV=100 IBV=1m)',
                },
            ],
    ...
    },
    {
        ...
        description:
            '2nd-order unity-gain Sallen-Key active low-pass (op-amp), cutoff ≈1kHz, 40dB/decade rolloff. Run a transient with the built-in 200Hz source to see the passband, or sweep the source frequency. (Validated: unity passband gain.)',
    ...
    },
    {
        ...
        description:
            'Square-wave relaxation oscillator (op-amp comparator + RC, the 555 astable function), self-starting, ~1.1kHz, rail-to-rail. Run a transient (≥5ms) to see the oscillation. (Validated: ~1.1kHz, ±15V.)',
    ...
    },
    {
        ...
        description:
            'Complementary NPN/PNP emitter-follower output stage with diode bias to minimize crossover distortion. ±15V rails, 1kHz input → the output follows the input into the load. (Validated: ~9.9Vpp follower.)',
    ...
    },
    {
        ...
        description:
            '4-bit resistor-ladder digital-to-analog converter. The 4 bit sources (here set to 1010 = decimal 10) produce a weighted analog output. Run an operating-point (op) analysis: Vout = Vref·code/16 = 5·10/16 = 3.125V. (Validated: 3.125V exact.)',
