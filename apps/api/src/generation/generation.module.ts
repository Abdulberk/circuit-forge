...
@Module({
    ...
    controllers: [GenerationController, DesignController, VerificationController],
    providers: [GenerationService, DesignService, VerificationService, CatalogGroundingService, CircuitSimulatorService],
})
