...
describe('I-IDENTITY — the delivered bundle must be assemblable', () => {
    ...
    const twoR1 = {
        version: '1.0',
        components: [
            { id: 'a', type: 'resistor', designator: 'R1', value: '1k', footprint: '0603', pins: [{ pinId: '1', netId: 'n0' }, { pinId: '2', netId: 'gnd' }] },
            { id: 'b', type: 'resistor', designator: 'R1', value: '2k', footprint: '0603', pins: [{ pinId: '1', netId: 'n0' }, { pinId: '2', netId: 'gnd' }] },
            { id: 'gnd1', type: 'ground', designator: 'GND1', pins: [{ pinId: '1', netId: 'gnd' }] },
        ],
        nets: [{ id: 'gnd', name: 'GND', isGround: true }, { id: 'n0', name: 'N0' }],
    ...
    it('distinct designators pass — the check is about collision, not about count', () => {
        const ok = {
            ...
            components: [
                twoR1.components[0]!,
                { ...twoR1.components[1]!, designator: 'R2' },
                twoR1.components[2]!,
            ],
        } as CircuitJson;
...
describe('the pad-accounting checks announce themselves when they cannot run', () => {
    ...
    it('no oracle -> an explicit "did not run" diagnostic, and no NC number invented', () => {
        const circuit = {
            version: '1.0',
            components: [
                { id: 'u1', type: 'resistor', designator: 'R1', value: '1k', footprint: 'SOIC-8', pins: [{ pinId: '1', netId: 'n0' }, { pinId: '2', netId: 'gnd' }] },
                { id: 'gnd1', type: 'ground', designator: 'GND1', pins: [{ pinId: '1', netId: 'gnd' }] },
            ],
            nets: [{ id: 'gnd', name: 'GND', isGround: true }, { id: 'n0', name: 'N0' }],
        } as unknown as CircuitJson;
